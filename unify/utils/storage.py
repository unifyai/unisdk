...
def get_signed_url(
    ...
    *,
    ...
    Args:
        gcs_uri: The GCS URI of the object (e.g., "gs://bucket/path/to/object").
    ...
    Example:
        >>> import unify
        >>> url = unify.get_signed_url("gs://bucket/images/photo.jpg")
...
def download_object(
    ...
    *,
    ...
    Example:
        >>> import unify
        >>> content = unify.download_object("gs://bucket/data/file.txt")
...
def get_object_info(
    ...
    *,
    ...
    """
    Get metadata about a GCS object without downloading its content.

    Retrieves the content type and size of a Google Cloud Storage object.
    ...
    Example:
        >>> import unify
        >>> info = unify.get_object_info("gs://bucket/images/photo.jpg")
        >>> print(f"Type: {info['content_type']}, Size: {info['size_bytes']} bytes")
    """
    api_key = _validate_api_key(api_key)
    headers = _create_request_header(api_key)
    ...
    return {
        "content_type": resp_json.get("content_type"),
        "size_bytes": resp_json.get("size_bytes"),
    }
