...
class TestGetSignedUrl:
    ...
    def test_returns_signed_url(self):
        ...
        with patch.object(
            ...
            result = unisdk.get_signed_url("gs://bucket/path/to/object.jpg")
            ...
            assert (
                call_args[1]["json"]["gcs_uri"] == "gs://bucket/path/to/object.jpg"
            )
...
class TestDownloadObject:
    ...
    def test_returns_decoded_bytes(self):
        ...
        with patch.object(
            ...
            result = unisdk.download_object("gs://bucket/hello.txt")

            assert result == test_content
            mock_post.assert_called_once()
            call_args = mock_post.call_args
            assert "/storage/download" in call_args[0][0]
            assert call_args[1]["json"]["gcs_uri"] == "gs://bucket/hello.txt"
